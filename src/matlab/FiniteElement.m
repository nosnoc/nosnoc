                        ...
                        if settings.pss_lift_step_functions
                            if ~settings.friction_is_present
                                switch model.n_unilateral
                                  case 1
                                    gamma = SX.sym(['gamma_'  num2str(ctrl_idx-1) '_' num2str(fe_idx-1) '_' num2str(ii)],2);
                                    obj.addVariable(gamma,...
                                                    'gamma',...
                                                    -inf*ones(dims.n_gamma,1),...
                                                    inf*ones(dims.n_gamma,1),...
                                                    full(model.g_lift_gamma_fun(initial_alpha*ones(n_alpha,1))),...
                                                    ii);
                                  case 2
                                    gamma = SX.sym(['gamma_'  num2str(ctrl_idx-1) '_' num2str(fe_idx-1) '_' num2str(ii)],4);
                                    beta = SX.sym(['beta_'  num2str(ctrl_idx-1) '_' num2str(fe_idx-1) '_' num2str(ii)],5);
                                    obj.addVariable(gamma,...
                                                    'gamma',...
                                                    -inf*ones(dims.n_gamma,1),...
                                                    inf*ones(dims.n_gamma,1),...
                                    ...
                                    obj.addVariable(beta,...
                                                    ...
                                                    inf*ones(dims.n_beta,1),...
                                                    full(model.g_lift_beta_fun(initial_alpha*ones(n_alpha,1))),...
                                                    ii);
                                end
                            else
                                beta = SX.sym(['beta_'  num2str(ctrl_idx-1) '_' num2str(fe_idx-1) '_' num2str(ii)],1);
                                gamma = SX.sym(['gamma_'  num2str(ctrl_idx-1) '_' num2str(fe_idx-1) '_' num2str(ii)],3);
                                obj.addVariable(gamma,...
                                                'gamma',...
                                                -inf*ones(dims.n_gamma,1),...
                                                inf*ones(dims.n_gamma,1),...

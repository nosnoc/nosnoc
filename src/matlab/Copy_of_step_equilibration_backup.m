...
if step_equilibration
            ...
            if ~(i == 0 && k== 0)
                ...
                switch step_equilibration_mode
                    case 1
                        %                     J_regularaize_delta_h  = J_regularaize_delta_h + 1*nu_k*delta_h_ki^2;
                    ...
                    case 3
                        ...
                        %                             ubg = [ubg; 0];
                        M_elastic = 1e3;
                        g = {g{:}, [(nu_k)*delta_h_ki-s_elastic*M_elastic;-(nu_k)*delta_h_ki-s_elastic*M_elastic]};
                        lbg = [lbg; [-inf;-inf]];
                        ubg = [ubg; [0;0]];
                    case 4
                        %                             g = {g{:}, (nu_k)*delta_h_ki^2};
                        M_elastic = 1e4;
                        g = {g{:}, (nu_k)*delta_h_ki^2-s_elastic*M_elastic};
                        lbg = [lbg; -inf];
                        ubg = [ubg; 0];
                    case 5

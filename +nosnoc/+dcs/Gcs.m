...
%     \end{align*}
    properties
        ...
        c % casadi.SX or casadi.MX: CasADi expression for gap functions, in case of lifting c=c_lift.
        g_c_lift % casadi.SX or casadi.MX: Lifting constraint expression for c_lift. Empty if lifting is not used.

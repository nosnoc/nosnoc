...
class HomotopySolver{
 ...
 private:
  std::vector<double> m_lbw = {0, 0, 0};
  std::vector<double> m_ubw = {inf, inf, 10};
  std::vector<double> m_init_lam_w = {0, 0, 0};
  std::vector<double> m_lbg = {-inf};
  std::vector<double> m_ubg = {0};
  std::vector<double> m_init_lam_g = {0};
  std::vector<double> m_p0 = {0, 1};
  std::vector<double> m_x0 = {0, 0, 1};

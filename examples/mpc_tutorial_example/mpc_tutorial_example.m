...
mpecopt_options = mpecopt.Options(); % Initialize all options related to the MPEC solver used for solving nosonc problems.
...
homotopy_options.homotopy_update_rule = 'superlinear'; % Use superlinear update rule for relaxation parameter sigma.
homotopy_options.homotopy_update_slope = 0.05; % Rate which the relaxation sigma is reduced at: sigma_i+1 = kappa*sigma_i 
homotopy_options.homotopy_update_exponent = 2; % Rate which the relaxation sigma is reduced at: sigma_i+1 = sigma_i^kappa
homotopy_options.complementarity_tol = 1e-7; % Value to drive the complementarity residual to.
homotopy_options.N_homotopy = 10; % Maximum number of homotopy iterations.
homotopy_options.print_level = 0;

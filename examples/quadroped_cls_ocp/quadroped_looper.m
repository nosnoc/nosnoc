...
n_u = 4;
T = {3,4,3,2.5,5,6,3,4};
N_FE = {2,2,2,2,2,2,3,2};
N_stg = {20,30,30,40,40,25,40,30};
max_iter = {3e3,4e3,3e3,3e3,3e3,5e3,2e3,3e3};
cross_comp_mode = {1,1,1,1,1,1,1,1};
q_x_final = {3,3,3,3,3,3,3,3};
IrkScheme = {IRKSchemes.RADAU_IIA,IRKSchemes.RADAU_IIA,IRKSchemes.RADAU_IIA,IRKSchemes.RADAU_IIA,IRKSchemes.RADAU_IIA,IRKSchemes.RADAU_IIA,IRKSchemes.RADAU_IIA,IRKSchemes.RADAU_IIA};

...
% settings.opts_casadi_nlp.ipopt.start_with_resto = 'yes';
% settings.opts_casadi_nlp.ipopt.resto_penalty_parameter = 0.1;
% settings.opts_casadi_nlp.ipopt.bound_mult_reset_threshold = 0.1;
% settings.opts_casadi_nlp.ipopt.constr_mult_reset_threshold = 0.1;

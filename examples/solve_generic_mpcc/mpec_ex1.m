...
solver_ks = mpccsol('generic_mpcc', 'kanzow_schwartz_ineq', mpcc_struct, mpccsol_opts);
solver_su = mpccsol('generic_mpcc', 'steffensen_ulbrich_ineq', mpcc_struct, mpccsol_opts);

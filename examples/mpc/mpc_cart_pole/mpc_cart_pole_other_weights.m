...
scenarios= {'Ideal-MPC','HyRTI','HyAS-RTI-QPCC','Smoothing','HyRTI-fast','HyAS-RTI-QP'};
...
for kk = [2 3]
    ...
    homotopy_options.opts_casadi_nlp.ipopt.linear_solver = 'ma97'; %
    ...
    if model_plant_missmatch
        ...
        sim_solver_options.opts_casadi_nlp.ipopt.linear_solver = 'ma97'; % Using an HSL solver is a significant speedup over the default 'mumps' but requires installation
    ...
    if create_video
        ...
        outputVideo.FrameRate = 20; % Adjust the frame rate as needed
        open(outputVideo);
